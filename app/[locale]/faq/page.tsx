...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      images: [{ url: "/images/hero-sunset.jpg", width: 1200, height: 630, alt: "Lake Como private boat tour FAQ" }],
    },
    twitter: { card: "summary_large_image", title: TITLES[locale], description: DESCS[locale], images: ["/images/hero-sunset.jpg"] },
  };
}
